...
print("Total number of loans:", total_number_of_loans )
...
print("Total value of loans:", total_value_of_loans)

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_value_of_loans = total_value_of_loans / total_number_of_loans
print("The average loan amount is:", average_value_of_loans)
...
print("The future value is:",  future_value, "And the remaining months is :" , remaining_months)
...
#    Else, the present value of the loan is less than the loan cost, then print a message that says that the loan is too expensive and not worth the pric
...
# @TODO: Print the `inexpensive_loans` 
